//
//  TGLOEditPersonFromListViewController.h
...
@interface TGLOEditPersonFromListViewController : UIViewController<UITextFieldDelegate, UIActionSheetDelegate, UITextViewDelegate>

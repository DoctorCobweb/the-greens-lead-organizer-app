...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *dateLabel   = [[UILabel alloc] initWithFrame:CGRectMake(0, 105, 80, 30)];
        UILabel *noteLabel   = [[UILabel alloc] initWithFrame:CGRectMake(0, 140, 320, 30)];
        ...
        UILabel *dateValue = [[UILabel alloc] initWithFrame:CGRectMake(85, 105, 200, 30)];
        UITextView *noteValue = [[UITextView alloc] initWithFrame:CGRectMake(0, 175, 280, 150)];
        ...
        dateValue.font   = font_;
        noteValue.font   = font_;
        ...
        dateLabel.backgroundColor   = backgroundLabel;
        ...
        dateValue.backgroundColor = backgroundValue;

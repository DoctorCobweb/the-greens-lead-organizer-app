//
//  TGLOEventsModalSearchViewController.m
//  Vic Greens
//
...
@interface TGLOEventsModalSearchViewController () {
...
@implementation TGLOEventsModalSearchViewController
...
{
    TGLOEditPersonFromSearchViewController *delegate = [self delegate];

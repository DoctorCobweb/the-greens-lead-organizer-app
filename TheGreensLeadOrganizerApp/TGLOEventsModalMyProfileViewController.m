//
//  TGLOEventsModalMyProfileViewController.m
//  Vic Greens
//
...
//static NSString *eventsUrl = @"http://localhost:5000/events/all/%@/%@";

@interface TGLOEventsModalMyProfileViewController () {
...
@implementation TGLOEventsModalMyProfileViewController

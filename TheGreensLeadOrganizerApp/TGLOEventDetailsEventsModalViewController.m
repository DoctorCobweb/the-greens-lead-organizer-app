//
//  TGLOEventDetailsEventsModalViewController.m
//  Vic Greens
//
...
@interface TGLOEventDetailsEventsModalViewController () {
...
@implementation TGLOEventDetailsEventsModalViewController
...
{
    TGLOEditPersonFromRsvpViewController *delegate = [self delegate];

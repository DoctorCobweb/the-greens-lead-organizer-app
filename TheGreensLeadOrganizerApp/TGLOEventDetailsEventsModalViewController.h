//
//  TGLOEventDetailsEventsModalViewController.h
//  Vic Greens
//
//  Created by andre on 12/06/2014.
...
@interface TGLOEventDetailsEventsModalViewController : UIViewController<UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate>


@property (weak, nonatomic) IBOutlet UISearchBar *searchBar;
@property (weak, nonatomic) IBOutlet UITableView *tableView;

//passed in from TGLOEditPersonFromRsvpViewController
@property (strong, nonatomic) NSNumber *personIdFromList;
@property (strong, nonatomic) TGLOEditPersonFromRsvpViewController *delegate;
